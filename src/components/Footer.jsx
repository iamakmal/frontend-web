...
export default function Footer() {
  return (
    <>
<footer className="footer p-10 bg-main text-white px-[80px]">
  <aside>
...
<footer className="footer px-[405px] py-4 border-t bg-main text-white">
