...
export default function Hero() {
  return (
    ...
    <img src="./Hero.png" alt="Hero" className="h-[218px] w-full object-cover md:h-[448px]"/>
    <div className="w-full h-[294px] md:h-[258px] lg:absolute lg:top-[354px] lg:left-20 lg:h-[306px] flex flex-col bg-gradient-to-r from-[#4DCA79] to-[#1CBDDD] pt-[24px] pr-[40px] pb-[32px] pl-[40px]">
    <div>
